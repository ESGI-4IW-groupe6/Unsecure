...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UnsecureBundle', ($this->targetDirs[2].'/Resources/UnsecureBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UnsecureBundle', '/application/src/UnsecureBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mariadb', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/application/src/UnsecureBundle/Entity')), 'UnsecureBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_297f3208c542b006c034a54f657113052917098f64dc655b0f24cd7e8670296c');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/application/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/application/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/application/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/application/vendor/symfony/swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/application/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/application/src/UnsecureBundle/Resources/views', 'Unsecure');
        $instance->addPath('/application/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    /*
     * Gets the 'unsecure.listener.add_session_data_twig_global' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UnsecureBundle\Listener\AddSessionDataTwigGlobal A UnsecureBundle\Listener\AddSessionDataTwigGlobal instance
     */
    ...
    /*
     * Gets the 'unsecure.login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UnsecureBundle\Service\LoginService A UnsecureBundle\Service\LoginService instance
     */
    ...
    /*
     * Gets the 'unsecure.repository.session' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /*
     * Gets the 'unsecure.repository.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /*
     * Gets the 'unsecure.session' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UnsecureBundle\Service\SessionService A UnsecureBundle\Service\SessionService instance
     */
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/application/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bc9aab12a1ac9.56354169')), true);
